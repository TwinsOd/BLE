...
package com.example.easysitapp;
        ...
        public void onClick(View v) {
            ...
            switch (v.getId()) {
                case R.id.imageButton1: {
                    ...
                    mBluetoothLeService.send_io_data("f6");//IO������ܹ���
                ...
                case R.id.tx_button://uuid1002 ����ͨ����������
                    ...
                    break;
//        	case R.id.id_button ://���ڶ�ȡ�豸ID
//        	{
//        		String tx_string="aa5510eb3ced8e43e21e10a07f9607dd9709f1"; ;
//        		mBluetoothLeService.txxx(tx_string);
//        		Toast toast = Toast.makeText(DeviceControlActivity.this, "���ڶ�ȡ�豸ID��", Toast.LENGTH_SHORT); 
//    			toast.show(); 
//        		break;
//        	}
//        	case R.id.pass_button ://���ڸ�������
//        	{
//        		Toast toast = Toast.makeText(DeviceControlActivity.this, "���ڸ������룡", Toast.LENGTH_SHORT); 
//    			toast.show(); 
//        		break;
//        	}
//        	case R.id.name_button ://���ڸ����豸��
//        	{
//        		Toast toast = Toast.makeText(DeviceControlActivity.this, "���ڸ����豸����", Toast.LENGTH_SHORT); 
//    			toast.show(); 
//        		break;
//        	}
                default:
    ...
    private void displayGattServices(List<BluetoothGattService> gattServices) {
        ...
        if (gattServices.size() > 0 && mBluetoothLeService.get_connected_status(gattServices) >= 4) {
            if (connect_status_bit) {
                ...
                show_view(true);
                mBluetoothLeService.enable_JDY_ble(true, 1);//IO������ܹ���
                try {
                    Thread.currentThread();
                    Thread.sleep(100);
                } catch (InterruptedException e) {
