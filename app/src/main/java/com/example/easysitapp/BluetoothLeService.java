...
public class BluetoothLeService extends Service {
    ...
    public static String Characteristic_uuid_IO = "0000ffe2-0000-1000-8000-00805f9b34fb";
    ...
    public void send_io_data(String g) {
        g = "E7" + g;
        WriteBytes = hex2byte(g.toString().getBytes());
        BluetoothGattCharacteristic gg;
        gg = mBluetoothGatt.getService(UUID.fromString(Service_uuid)).getCharacteristic(UUID.fromString(Characteristic_uuid_IO));
        gg.setValue(WriteBytes);
        mBluetoothGatt.writeCharacteristic(gg);
    }


    public void enable_JDY_ble(boolean p, int s) {
